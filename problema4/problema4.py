...
# Clase Aplicacion para crear la interfaz gráfica (ventana, botones, etiquetas) con tkinter 
...
class Aplicacion:
    ...
    def buscar_palabra(self):
        ...
        total_ocurrencias, resultados = contar_ocurrencias_palabra(codigo_fuente, palabra_buscar)
